...
const faqs = [
  {
    q: 'KOD 是什么？',
    a: 'KOD 是一款面向蒜粒期货市场的专业 AI 助手客户端。它不仅支持多模型对话与全平台使用，更深度集成 KAI 期算标准——帮助企业将模型服务容量从不确定的弹性调用升级为可计划、可交易、可保障的期货化资产。',
  },
  {
    q: 'KAI 期算是什么？',
    a: (
  ...
  {
    q: 'KOD 和 KAI 期算是什么关系？',
    a: 'KOD 是承载 KAI 期算标准的前端客户端与工作平台。KAI 期算定义了市场的规则、合约品种和交割标准；KOD 提供用户使用这些市场能力的界面——包括查看行情、管理持仓、参与竞价、监控交割状态，同时保留完整的 AI 对话与工具功能。简言之：KAI 制定标准，KOD 交付体验。',
  },
  {
    q: 'KOD 收费吗？',
  ...
  {
    q: '谁适合使用 KOD + KAI 期算？',
    a: '核心用户是需要在关键时段获得确定模型容量的企业——电商大促期间的智能客服、金融机构的报告批量生成、内容平台的定时内容审核等。对模型容量有明确时间要求的企业，KAI 期算将容量从「尽力而为」升级为合同义务。同时，KOD 也适合希望用 AI 提升日常生产力的个人用户。',
  },
  {
    q: '如何开始使用 KAI 期算？',
    a: '目前 KAI 期算处于白皮书与联合设计阶段（阶段 0），欢迎企业用户、模型供应商和行业合作伙伴通过意见反馈页面或邮件联系团队。KOD 客户端已于 2026 年 7 月上线，下载即可体验 AI 助手核心功能，后续版本将逐步开放市场交易能力。',
  },
  {
    q: '支持哪些平台？',
  ...
  {
    q: '我的数据安全吗？',
    a: 'KOD 采用本地优先策略，会话数据默认存储在本地设备，隐私安全由你掌控。容量交易数据通过后端服务管理，与本地对话数据分离，确保企业信息安全。',
  },
  {
    q: '如何反馈问题？',
...
function FaqPage() {
  return (
    <section className="mx-auto max-w-3xl px-6 py-20">
      ...
      <p className="mt-4 text-gray-600">关于 KOD 与 KAI 期算的常见疑问解答。</p>
